...
class AppDatabase {
  ...
  createTables(Database db) {
    ...
    db.execute(
      'CREATE TABLE fadfada(id INTEGER PRIMARY KEY AUTOINCREMENT, category TEXT, text TEXT, is_pinned INTEGER, created_at INTEGER)',
    );
  }
  ...
  updateTables(Database db) {
    ...
    db.execute(
      'CREATE TABLE IF NOT EXISTS fadfada(id INTEGER PRIMARY KEY AUTOINCREMENT, category TEXT, text TEXT, is_pinned INTEGER, created_at INTEGER)',
    );
  }
