              ...
              child: SingleChildScrollView(
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      const SubtitleTextWidget(label: 'اضافة اقتباس', textAlign: TextAlign.center,overflew: TextOverflow.ellipsis),
                      verticalSpace(10),
                      Form(
                        ...
                        children: [
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              suffixIcon: viewModel.userNameController.text.isNotEmpty ? GestureDetector(
                                onTap: () => viewModel.clearUserName(),
                                child: Icon(IconlyLight.close_square,
                                    color: Theme.of(context).cardColor),
                              ) : null,
                              prefixIcon : Icon(IconlyLight.user,color: Theme.of(context).iconTheme.color),
                              labelText: 'إسمك',
                            ),
                            validator: (value){
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              prefixIcon: Icon(IconlyLight.paper,color: Theme.of(context).iconTheme.color),
                              suffixIcon: viewModel.postController.text.isNotEmpty ? GestureDetector(
                              ...
                              if(result){
                                showTopSnackBar(
                                  ...
                                  CustomSnackBar.success(
                                    ...
                                    message: "تم إرسال الاقتباس بنجاح للمراجعة\nسوف تتلقى إشعارًا عند الموافقة.",
                                    icon: Icon(
                                      Icons.access_alarm,
                                      color: Theme.of(context).cardColor,
                                      size: 50,
